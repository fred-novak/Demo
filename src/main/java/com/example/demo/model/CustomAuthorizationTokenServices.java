...
public class CustomAuthorizationTokenServices implements AuthorizationServerTokenServices, ConsumerTokenServices {
	...
	/*private int refreshTokenValiditySeconds = GuardConstant.REFRESHTOKEN_EXPIRE_IN;

	private int accessTokenValiditySeconds = GuardConstant.TOKEN_EXPIRE_IN; */
